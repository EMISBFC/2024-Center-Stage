...
public class AABlueFarMiddleParking extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Action drop2_2 = drive.actionBuilder(new Pose2d(-117,9,(3*Math.PI)/2))
                .waitSeconds(0.4)
                .strafeTo(new Vector2d(-117,50))
                .waitSeconds(0.2)
                .strafeTo(new Vector2d(-145,50))
                .waitSeconds(0.2)
                .strafeTo(new Vector2d(-145,-27))
                .waitSeconds(0.2)
                .strafeTo(new Vector2d(110,-27))
                .waitSeconds(0.2)
                .strafeTo(new Vector2d(110,-22))
        ...
        Action drop3_2 = drive.actionBuilder(new Pose2d(-133,20,(3*Math.PI)/2))
                .waitSeconds(0.4)
                .strafeTo(new Vector2d(-133,50))
                .waitSeconds(0.2)
                .strafeTo(new Vector2d(-170,50))
                .waitSeconds(0.2)
                .strafeTo(new Vector2d(-170,-27))
                .waitSeconds(0.2)
                .strafeTo(new Vector2d(110,-27))
                .waitSeconds(0.2)
                .strafeTo(new Vector2d(110,-22))
