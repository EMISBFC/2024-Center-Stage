...
@Autonomous(name = "Auto Test Blue Close", group = "IterativeOpMode")//iterative maybe?
public class AutoTestBlueClose extends LinearOpMode {
    /*
    ...
    public void runOpMode()
    {
        ...
        zone = vision.elementDetection(telemetry, new Scalar(0, 255, 0, 1));
        ...
        Pose2d postConeRedBackAlliance = new Pose2d(12, 30, 0);
