...
public class OldArmCode {
    ...
    public OldArmCode(DcMotorController dcMotorController, HardwareMap hardwareMap, ServoController servoController){//need to change port number upon build
